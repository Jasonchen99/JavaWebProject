                                            ...
                                            <div class="am-btn-toolbar">
                                                <div class="am-btn-group am-btn-group-xs">
                                                    <button type="button" id="depart_27"
                                                        ...
                                                        <a href="BrandServlet?method=display1Brand&bid=${b.bid}&bname=${b.bname}">编辑</a>
                                                    </button>
                                                    <button
                                                            type="button"
                                                            class="am-btn am-btn-default am-btn-xs am-text-danger amt-hide-sm-only">
                                                        <span class="am-icon-trash-o"></span> <a href="BrandServlet?method=deleteBrand&bid=${b.bid}">删除</a>
                                                    </button>
                                                </div>
                                            </div>
                                        </td>
    ...
    $(function () {
        /*$(".btnedit").click(function () {
            $.jq_Panel({
                ...
                iframeWidth: 500,
                iframeHeight: 300,
                url: "BrandServlet?method=display1Brand&bid=1"
            });
        });*/
